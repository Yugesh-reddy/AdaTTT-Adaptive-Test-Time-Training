...
def main():
    ...
    # Rotation re-encodes rotated images → needs live images.
    ...
    for batch in tqdm(val_loader, desc=f"Adaptive τ={threshold}"):
        ...
        if use_features:
            ...
            logits, routing_info = router.predict_cached(
                visual_tokens, text_tokens, attention_mask, images=images
            )
        else:
...
if __name__ == "__main__":
    main()
# Propagate cached features across GPU inference scripts

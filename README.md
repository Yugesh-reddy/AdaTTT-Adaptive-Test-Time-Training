...
An adaptive VQA system that learns to selectively apply test-time training using a confidence gate, producing a Pareto frontier of accuracy vs compute cost.
...
│   ├── data.py                 # VQA-v2 / VizWiz dataset classes
